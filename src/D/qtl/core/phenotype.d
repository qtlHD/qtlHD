...
Phenotype set_phenotype(T)(in string s) {
  // writeln(s);
  Phenotype p;
  if(s == "NA" || s == "-"){
...
size_t[][] create_phenotype_batches(T)(Phenotype[][] pheno)
{
...
string create_missing_phenotype_pattern(T)(Phenotype[][] pheno, size_t pheno_column)
{
  string pattern;
...
// batches of phenotypes with common missing data patterns
size_t[][string] create_phenotype_batches_hash(T)(Phenotype[][] pheno)
{
